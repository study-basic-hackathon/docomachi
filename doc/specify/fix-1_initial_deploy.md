AWS Amplifyのコンソールで最初のデプロイを実行したところ、以下のようなログが出ており、デプロイに失敗しました。原因を調査して修正してください。必要であればGitHubのテンプレートhttps://github.com/aws-samples/amplify-next-templateを参考にしてください。
